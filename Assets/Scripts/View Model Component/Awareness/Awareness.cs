...
public class Awareness: IEquatable<Awareness>
{
	...
	// If the type changes, return TRUE.
	// Otherwise, return FALSE and just update level and point of interest.
	// ** Don't call this method directly, use the AwarenessControll instead.
